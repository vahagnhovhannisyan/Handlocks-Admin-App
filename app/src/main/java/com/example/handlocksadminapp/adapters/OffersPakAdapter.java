...
public class OffersPakAdapter extends RecyclerView.Adapter<OffersPakAdapter.ViewHolder> {
    Context context;
    List<OffersModel> list;
    FirebaseFirestore firestore;

    public OffersPakAdapter(Context context, List<OffersModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.deleteItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("OffersPak").document(list.get(a).getDocumentId())
