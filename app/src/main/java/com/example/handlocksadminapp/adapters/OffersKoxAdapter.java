...
public class OffersKoxAdapter extends RecyclerView.Adapter<OffersKoxAdapter.ViewHolder> {
    Context context;
    List<OffersModel> list;
    FirebaseFirestore firestore;

    public OffersKoxAdapter(Context context, List<OffersModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.deleteItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("OffersKox").document(list.get(a).getDocumentId())
