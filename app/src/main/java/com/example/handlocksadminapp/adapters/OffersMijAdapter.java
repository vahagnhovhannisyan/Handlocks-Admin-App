...
public class OffersMijAdapter extends RecyclerView.Adapter<OffersMijAdapter.ViewHolder> {
    Context context;
    List<OffersModel> list;
    FirebaseFirestore firestore;

    public OffersMijAdapter(Context context, List<OffersModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.deleteItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("OffersMij").document(list.get(a).getDocumentId())
