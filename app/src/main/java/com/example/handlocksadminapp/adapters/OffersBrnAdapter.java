...
public class OffersBrnAdapter extends RecyclerView.Adapter<OffersBrnAdapter.ViewHolder> {
    Context context;
    List<OffersModel> list;
    FirebaseFirestore firestore;

    public OffersBrnAdapter(Context context, List<OffersModel> list) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.deleteItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firestore.collection("OffersBrn").document(list.get(a).getDocumentId())
